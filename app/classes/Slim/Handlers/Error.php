...
class Error
{
    ...
    protected function writeToErrorLog($exception)
    {
        ...
        $message = 'Rest Api Application Error:' . PHP_EOL;
    ...
    {
        $title = 'Rest Api Application Error';
    ...
    protected function renderJsonErrorMessage(Exception $exception)
    {
        $error = [
            "success" => 0,
            'message' => 'Rest Api Application Error',
        ];
    ...
    {
        $xml = "<error>\n<success>0</success><message>Rest Api Application Error</message>\n";
        if ($this->displayErrorDetails) {
            do {
                $xml .= "  <exception>\n";
